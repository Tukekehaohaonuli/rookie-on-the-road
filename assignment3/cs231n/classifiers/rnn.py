...
class CaptioningRNN(object):
    ...
    def __init__(self, word_to_idx, input_dim=512, wordvec_dim=128,
        ...
        self.params['W_embed'] = np.random.randn(vocab_size, wordvec_dim)  #[V,D]
    ...
    def loss(self, features, captions):
        ...
        dout,dW_vocab,db_vocab=temporal_affine_backward(dscore,cache2)
        grads['W_vocab']=dW_vocab
        grads['b_vocab']=db_vocab
        
        if self.cell_type=='rnn':   
            dout,dh0,dWx,dWh,db=rnn_backward(dout,cache1)
        else:
            dout,dh0,dWx,dWh,db=lstm_backward(dout,cache1)
       # grads['h0']=dh0
        grads['Wx']=dWx
        grads['Wh']=dWh
        grads['b']=db
        
        dW_embed=word_embedding_backward(dout,cache0)
        grads['W_embed']=dW_embed
        
        dout,dW_proj,db_proj=affine_backward(dh0,cache_0)
    ...
    def sample(self, features, max_length=30):
        ...
        # a loop.                                                                 #
        ###########################################################################
#         h,cache0=affine_forward(features,W_proj,b_proj)
